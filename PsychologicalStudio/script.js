document.addEventListener('DOMContentLoaded', function() {
    ...
    style.textContent = `
        ...
        /* Piano roll filter controls styling */
        .piano-roll-filters {
            margin-top: 15px;
            padding-top: 15px;
    ...
    effectsPopup.innerHTML = `
        ...
        <div class="popup-content">
            ...
            <br>
                ...
                <!-- Enhanced Piano Roll Filter Controls -->
                <div class="piano-roll-filters">
                    <h4>Piano Roll Filters</h4>
                    
                    <div class="enhanced-filter-controls">
                        <div class="filter-group">
                            <h5>Frequency Filters</h5>
                            <div class="filter-control">
                                <label>Low Cut:</label>
                                <input type="range" id="piano-roll-lowcut" min="20" max="1000" value="20" step="10">
                                <span id="piano-roll-lowcut-value">20Hz</span>
                            </div>
                            <div class="filter-control">
                                <label>High Cut:</label>
                                <input type="range" id="piano-roll-highcut" min="1000" max="20000" value="20000" step="100">
                                <span id="piano-roll-highcut-value">20kHz</span>
                            </div>
                            <div class="filter-control">
                                <label>Resonance:</label>
                                <input type="range" id="piano-roll-resonance" min="0.1" max="30" value="1" step="0.1">
                                <span id="piano-roll-resonance-value">1.0</span>
                            </div>
                        </div>
                        ...
                        <!-- New Reverb Filter Group -->
                        <div class="filter-group">
                            <h5>Reverb</h5>
                            <div class="filter-control">
                                <label>Decay (s):</label>
                                <input type="range" id="piano-roll-reverb-decay" min="0.1" max="5" value="0" step="0.1">
                                <span id="piano-roll-reverb-decay-value">0s</span>
                            </div>
                            <div class="filter-control">
                                <label>Mix (%):</label>
                                <input type="range" id="piano-roll-reverb-mix" min="0" max="100" value="0" step="1">
                                <span id="piano-roll-reverb-mix-value">0%</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    function initializeEffectsForSample(sampleNumber) {
        ...
        if (effects.pianoRoll && !pianoRollData[sampleNumber]) {
    ...
    function showEffectsPopup(sampleNumber, button) {
        ...
        if (temporaryEffects.pianoRoll && temporaryEffects.pianoRoll.filters) {
            document.getElementById('piano-roll-lowcut').value = temporaryEffects.pianoRoll.filters.lowCut || 20;
            document.getElementById('piano-roll-lowcut-value').textContent = formatFrequency(temporaryEffects.pianoRoll.filters.lowCut || 20);
            document.getElementById('piano-roll-highcut').value = temporaryEffects.pianoRoll.filters.highCut || 20000;
            document.getElementById('piano-roll-highcut-value').textContent = formatFrequency(temporaryEffects.pianoRoll.filters.highCut || 20000);
            document.getElementById('piano-roll-resonance').value = temporaryEffects.pianoRoll.filters.resonance || 1.0;
            document.getElementById('piano-roll-resonance-value').textContent = temporaryEffects.pianoRoll.filters.resonance || 1.0;
            ...
            document.getElementById('piano-roll-reverb-decay').value = temporaryEffects.pianoRoll.filters.reverb.decay || 0;
            document.getElementById('piano-roll-reverb-decay-value').textContent = `${temporaryEffects.pianoRoll.filters.reverb.decay || 0}s`;
            document.getElementById('piano-roll-reverb-mix').value = temporaryEffects.pianoRoll.filters.reverb.mix || 0;
            document.getElementById('piano-roll-reverb-mix-value').textContent = `${temporaryEffects.pianoRoll.filters.reverb.mix || 0}%`;
        }
    ...
    function initPianoRollFilters() {
        ...
        // Get filter controls
        const lowCutSlider = document.getElementById('piano-roll-lowcut');
        const highCutSlider = document.getElementById('piano-roll-highcut');
        const resonanceSlider = document.getElementById('piano-roll-resonance');
        ...
        const reverbDecaySlider = document.getElementById('piano-roll-reverb-decay');
        const reverbMixSlider = document.getElementById('piano-roll-reverb-mix');
        
        // Get value displays
        const lowCutValue = document.getElementById('piano-roll-lowcut-value');
        const highCutValue = document.getElementById('piano-roll-highcut-value');
        const resonanceValue = document.getElementById('piano-roll-resonance-value');
        ...
        const reverbDecayValue = document.getElementById('piano-roll-reverb-decay-value');
        const reverbMixValue = document.getElementById('piano-roll-reverb-mix-value');
        
        // Add event listeners
        lowCutSlider.addEventListener('input', function() {
            lowCutValue.textContent = formatFrequency(this.value);
            updatePianoRollFilters();
        });
        
        highCutSlider.addEventListener('input', function() {
            highCutValue.textContent = formatFrequency(this.value);
            updatePianoRollFilters();
        });
        ...
        reverbDecaySlider.addEventListener('input', function() {
            reverbDecayValue.textContent = `${this.value}s`;
            updatePianoRollFilters();
        });
        
        reverbMixSlider.addEventListener('input', function() {
            reverbMixValue.textContent = `${this.value}%`;
            updatePianoRollFilters();
        });
    }
    ...
    function updatePianoRollFilters() {
        if (!currentSampleForPopup || !pianoRollFilterNodes.lowCut) return;
        
        // Get filter values
        const lowCut = parseInt(document.getElementById('piano-roll-lowcut').value);
        const highCut = parseInt(document.getElementById('piano-roll-highcut').value);
        const resonance = parseFloat(document.getElementById('piano-roll-resonance').value);
        ...
        const reverbDecay = parseFloat(document.getElementById('piano-roll-reverb-decay').value);
        const reverbMix = parseInt(document.getElementById('piano-roll-reverb-mix').value);
        
        // Update filter nodes
        pianoRollFilterNodes.lowCut.frequency.value = lowCut;
        pianoRollFilterNodes.highCut.frequency.value = highCut;
        pianoRollFilterNodes.resonance.Q.value = resonance;
        ...
        if (pianoRollFilterNodes.reverb) {
            // Re-create the convolver with new parameters
            const convolver = audioContext.createConvolver();
            const length = audioContext.sampleRate * reverbDecay;
            const impulse = audioContext.createBuffer(2, length, audioContext.sampleRate);
            ...
            // Disconnect old convolver and connect new one
            if (pianoRollFilterNodes.reverb) {
                pianoRollFilterNodes.reverb.disconnect();
            }
            pianoRollFilterNodes.reverb = convolver;
            
            // Reconnect the convolver
            if (pianoRollFilterNodes.reverbMix) {
                pianoRollFilterNodes.reverb.connect(convolver);
                convolver.connect(pianoRollFilterNodes.reverbMix);
            }
        }
        if (pianoRollFilterNodes.reverbMix) {
            pianoRollFilterNodes.reverbMix.gain.value = reverbMix / 100;
        }
        ...
        if (pianoRollData[currentSampleForPopup]) {
            ...
            pianoRollData[currentSampleForPopup].filters.lowCut = lowCut;
            pianoRollData[currentSampleForPopup].filters.highCut = highCut;
            pianoRollData[currentSampleForPopup].filters.resonance = resonance;
            ...
            pianoRollData[currentSampleForPopup].filters.reverb = {
                decay: reverbDecay,
                mix: reverbMix
            };
        }
            ...
            navigator.mediaDevices.getUserMedia({ audio: true })
                .then(stream => {
                    ...
                    microphoneMediaRecorder.onstop = function() {
                        ...
                        recordStatusPerSample[sampleNumber] = 'Recording complete! Click Save to use this sample.';
                        recordStatus.textContent = recordStatusPerSample[sampleNumber];
    ...
    function resetEffectsSettings() {
        ...
        document.getElementById('piano-roll-lowcut').value = temporaryEffects.pianoRoll.filters.lowCut;
        document.getElementById('piano-roll-lowcut-value').textContent = formatFrequency(temporaryEffects.pianoRoll.filters.lowCut);
        document.getElementById('piano-roll-highcut').value = temporaryEffects.pianoRoll.filters.highCut;
        document.getElementById('piano-roll-highcut-value').textContent = formatFrequency(temporaryEffects.pianoRoll.filters.highCut);
        document.getElementById('piano-roll-resonance').value = temporaryEffects.pianoRoll.filters.resonance;
        document.getElementById('piano-roll-resonance-value').textContent = temporaryEffects.pianoRoll.filters.resonance;
        
        // Reset enhanced piano roll filters to default
        ...
        // Reset new piano roll filters to default
        ...
        document.getElementById('piano-roll-reverb-decay').value = temporaryEffects.pianoRoll.filters.reverb.decay;
        document.getElementById('piano-roll-reverb-decay-value').textContent = `${temporaryEffects.pianoRoll.filters.reverb.decay}s`;
        document.getElementById('piano-roll-reverb-mix').value = temporaryEffects.pianoRoll.filters.reverb.mix;
        document.getElementById('piano-roll-reverb-mix-value').textContent = `${temporaryEffects.pianoRoll.filters.reverb.mix}%`;
    ...
    document.getElementById('reverb-decay').addEventListener('input', function() {
        ...
        updateReverbInRealTime();
        if (temporaryEffects) {
            temporaryEffects.decay = parseFloat(this.value);
        }
    });
    ...
    document.getElementById('reverb-predelay').addEventListener('input', function() {
        ...
        updateReverbInRealTime();
        if (temporaryEffects) {
            temporaryEffects.predelay = parseFloat(this.value);
        }
    });
    ...
    document.getElementById('reverb-diffusion').addEventListener('input', function() {
        ...
        updateReverbInRealTime();
        if (temporaryEffects) {
            temporaryEffects.diffusion = parseFloat(this.value);
        }
    });
    ...
    document.getElementById('reverb-lowcut').addEventListener('input', function() {
        ...
        updateReverbInRealTime();
        if (temporaryEffects) {
            temporaryEffects.lowcut = parseFloat(this.value);
        }
    });
    ...
    document.getElementById('reverb-highcut').addEventListener('input', function() {
        ...
        updateReverbInRealTime();
        if (temporaryEffects) {
            temporaryEffects.highcut = parseFloat(this.value);
        }
    });
    ...
    document.getElementById('reverb-damping').addEventListener('input', function() {
        ...
        updateReverbInRealTime();
        if (temporaryEffects) {
            temporaryEffects.damping = parseFloat(this.value);
        }
    });
    ...
    document.getElementById('reverb-mix').addEventListener('input', function() {
        ...
        updateReverbInRealTime();
        if (temporaryEffects) {
            temporaryEffects.mix = parseInt(this.value);
        }
    });
            ...
            if (currentPlaying[i].button === button) {
                ...
                for (let j = 1; j <= 100; j++) {
                    if (Math.floor((j - 1) / 10) === group && currentPlaying[j].button) {
                        ...
                        // Remove indicators
                        removeIndicators(currentPlaying[j].button);
    ...
    function removeIndicators(button) {
        const customIndicator = button.querySelector('.custom-indicator');
        if (customIndicator) {
            customIndicator.style.display = 'none';
        }
    ...
    function previewPianoRoll() {
        ...
        lowCutFilter.frequency.value = data.filters.lowCut || 20;
        lowCutFilter.Q.value = 1.0;
        
        const highCutFilter = audioContext.createBiquadFilter();
        highCutFilter.type = 'lowpass';
        highCutFilter.frequency.value = data.filters.highCut || 20000;
        highCutFilter.Q.value = 1.0;
        
        const resonanceFilter = audioContext.createBiquadFilter();
        resonanceFilter.type = 'peaking';
        resonanceFilter.frequency.value = 1000; // Center frequency for resonance
        resonanceFilter.Q.value = data.filters.resonance || 1.0;
        resonanceFilter.gain.value = 0; // No gain boost by default
        
        // Enhanced filter nodes
        ...
        // Only create reverb if decay time is greater than 0
        let reverbConvolver = null;
        let reverbMixNode = null;
        const reverbDecay = data.filters.reverb.decay || 0;
        
        if (reverbDecay > 0) {
            try {
                const reverbLength = Math.max(1, audioContext.sampleRate * reverbDecay);
                ...
                reverbConvolver.buffer = reverbImpulse;
                
                reverbMixNode = audioContext.createGain();
                reverbMixNode.gain.value = (data.filters.reverb.mix || 0) / 100;
            } catch (e) {
        ...
        // Connect filters: previewGain -> lowCut -> highCut -> resonance -> lowShelf -> lowMid -> mid -> highMid -> highShelf -> delay -> (reverb) -> output
        previewGain.connect(lowCutFilter);
        lowCutFilter.connect(highCutFilter);
        highCutFilter.connect(resonanceFilter);
        resonanceFilter.connect(lowShelfFilter);
        ...
        // Connect reverb if it exists, otherwise connect delay to destination
        if (reverbConvolver && reverbMixNode) {
            delayNode.connect(reverbConvolver);
            reverbConvolver.connect(reverbMixNode);
            reverbMixNode.connect(audioContext.destination);
        } else {
            delayNode.connect(audioContext.destination);
        }
        
        // Connect dry signal (without effects) from highShelfFilter to destination
        highShelfFilter.connect(audioContext.destination);
        
        // Store filter nodes
        pianoRollFilterNodes = {
            lowCut: lowCutFilter,
            highCut: highCutFilter,
            ...
            reverb: reverbConvolver,
            reverbMix: reverbMixNode
        };
        
        // Find the last column to determine loop length
        const lastCol = Math.max(...sortedNotes.map(note => note.col));
        const loopDuration = (lastCol + 1) * sixteenthDuration;
    ...
    function startPianoRollLoop() {
        ...
        nodes.sortedNotes.forEach(note => {
    ...
    function playPianoNoteForPreview(row, time, duration, gainNode) {
        ...
        noteGain.gain.linearRampToValueAtTime(0, now + duration - releaseTime);
    ...
    function stopPianoRollPreview() {
        ...
        if (pianoRollFilterNodes.lowCut) {
            pianoRollFilterNodes.lowCut.disconnect();
            pianoRollFilterNodes.lowCut = null;
        }
        
        if (pianoRollFilterNodes.highCut) {
            pianoRollFilterNodes.highCut.disconnect();
            pianoRollFilterNodes.highCut = null;
        }
        
        if (pianoRollFilterNodes.resonance) {
            pianoRollFilterNodes.resonance.disconnect();
            pianoRollFilterNodes.resonance = null;
        }
        
        // Disconnect enhanced filter nodes
        if (pianoRollFilterNodes.lowShelf) {
        ...
        if (pianoRollFilterNodes.reverb) {
            pianoRollFilterNodes.reverb.disconnect();
            pianoRollFilterNodes.reverb = null;
        }
        
        if (pianoRollFilterNodes.reverbMix) {
            pianoRollFilterNodes.reverbMix.disconnect();
            pianoRollFilterNodes.reverbMix = null;
        }
    ...
    async function savePianoRollAsSampleForCurrentButton() {
        ...
        const lastCol = Math.max(...sortedNotes.map(note => note.col));
        const bufferLength = (lastCol + 1) * sixteenthDuration;
        ...
        if (reverbDecay > 0) {
            const reverbLength = Math.max(1, offlineContext.sampleRate * reverbDecay);
            ...
            reverbMixNode = offlineContext.createGain();
            reverbMixNode.gain.value = (data.filters.reverb.mix || 0) / 100;
        }
        
        // Connect filters: masterGain -> lowCut -> highCut -> resonance -> lowShelf -> lowMid -> mid -> highMid -> highShelf -> delay -> (reverb) -> destination
        masterGain.connect(lowCutFilter);
        lowCutFilter.connect(highCutFilter);
        highCutFilter.connect(resonanceFilter);
        resonanceFilter.connect(lowShelfFilter);
        lowShelfFilter.connect(lowMidFilter);
        ...
        if (reverbConvolver && reverbMixNode) {
            delayNode.connect(reverbConvolver);
            reverbConvolver.connect(reverbMixNode);
            reverbMixNode.connect(offlineContext.destination);
        } else {
    ...
    function renderPianoNote(offlineContext, row, time, duration, outputNode) {
        ...
        noteGain.gain.linearRampToValueAtTime(0, time + duration - releaseTime);
