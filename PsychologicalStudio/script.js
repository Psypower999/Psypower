document.addEventListener("DOMContentLoaded", function () {
    ...
    function updatePianoRollCellWidth() {
        ...
        if (barNumbers) {
            ...
            console.log(`Updating bar numbers: gridWidth=${gridWidth}, cellWidth=${cellWidth}, barNumberCount=${barNumberElements.length}`);
            barNumberElements.forEach((barElement, index) => {
                ...
                if (index < 3) console.log(`Bar ${index}: width=${newWidth}, fontSize=${newFontSize}px`);
            });
        }
